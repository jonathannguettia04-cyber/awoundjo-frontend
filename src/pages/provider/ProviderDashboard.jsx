  ...
  return (
    <div style={{ fontFamily: "'DM Sans',system-ui,sans-serif" }}>
      <style>{`
        ...
        .pd-action-grid { display: grid; grid-template-columns: repeat(4,1fr); gap: 14px; }
...
const s = {
  hero:        { background: "linear-gradient(135deg,#1E3A8A,#2563EB)", borderRadius: 20, padding: "24px 28px", marginBottom: 28, boxShadow: "0 8px 32px rgba(37,99,235,.2)" },
  ...
  heroBtn:     { background: "#fff", color: "#2563EB", border: "none", borderRadius: 12, padding: "13px 24px", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "inherit", boxShadow: "0 4px 16px rgba(0,0,0,.15)", whiteSpace: "nowrap" },
