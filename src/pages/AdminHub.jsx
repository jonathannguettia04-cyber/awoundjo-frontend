...
const SECTIONS = [
  // ── Administration ──────────────────────────────────────────
  {
    ...
    links: [
      ...
      { icon: "🔑", label: "Reset MDP clients",              path: "/admin/clients/reset-password",  desc: "Réinitialiser les mots de passe clients" },
      ...
      { icon: "💼", label: "Réseau Business",                path: "/admin/business",                desc: "Directrices, Leaders, Superviseurs, Recruteurs" },
    ],
  },
