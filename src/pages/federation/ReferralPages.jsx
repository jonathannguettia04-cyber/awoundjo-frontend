    ...
    <div style={{ padding:"24px 20px", maxWidth:900, margin:"0 auto" }}>
      ...
      {loading ? <Loader /> : list.length === 0 ? (
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
          {list.map(m => (
            <Card key={m.id} style={{ display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:12 }}>
    ...
    return (
      <div style={{ padding:"24px 20px", maxWidth:560, margin:"0 auto" }}>
        <Card style={{ textAlign:"center" }}>
          ...
          <div style={{ background:C.purpleL, borderRadius:12, padding:"16px 20px", margin:"20px 0" }}>
            <p style={{ margin:"0 0 6px", fontSize:13, color:C.slate }}>Numéro mutualiste</p>
            <p style={{ margin:0, fontSize:24, fontWeight:900, color:C.purple, fontFamily:"monospace" }}>{success.mutual_number}</p>
          </div>
          <p style={{ fontSize:13, color:C.slate, marginBottom:20 }}>
            Ce numéro est la carte d'adhérent du client. Conservez-le précieusement.
          </p>
