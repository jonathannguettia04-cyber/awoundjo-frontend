...
export default function Blog() {
  ...
  const cats = ["Tous", ...Array.from(new Set(BLOG_POSTS.map(p => p.category)))];
            ...
            <Link to={`/blog/${featured.slug}`} style={{
              ...
              <div style={{ padding: "40px 36px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <span style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: C.gray }}>{formatDate(featured.date)}</span>
              ...
              <Link key={post.slug} to={`/blog/${post.slug}`} style={{
                ...
                <div style={{ padding: "22px 22px 26px", flex: 1, display: "flex", flexDirection: "column" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <span style={{ fontFamily: "Inter, sans-serif", fontSize: 11.5, color: C.gray }}>{formatDate(post.date)}</span>
