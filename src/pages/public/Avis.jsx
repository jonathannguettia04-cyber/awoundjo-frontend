...
export default function Avis() {
  return (
    <>
      ...
      {/* ── STATS ────────────────────────────────────────────── */}
      <section style={{ background: C.white, padding: "56px 24px", borderBottom: "1.5px solid #E0EEF9" }}>
      ...
      <section style={{ background: C.cream, padding: "72px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ background: C.white, borderRadius: 20, padding: "40px 32px", border: "1.5px solid #E0EEF9", display: "flex", alignItems: "center", gap: 48, flexWrap: "wrap", justifyContent: "center" }}>
            ...
            <div style={{ flex: 1, minWidth: 200 }}>
              {[
                ...
                <div key={r.label} style={{ marginBottom: 10 }}>
                  ...
                  <div style={{ height: 6, borderRadius: 4, background: "#E0EEF9", overflow: "hidden" }}>
      ...
      {/* ── CTA PARTAGER ─────────────────────────────────────── */}
      <section style={{ background: C.greenPale, padding: "72px 24px", textAlign: "center", borderTop: "1.5px solid #D6E6F5" }}>
